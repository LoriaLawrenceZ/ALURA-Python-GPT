...
print(f"Custo para o modelo {modelo} é de ${(len(lista_tokens)/1000) * 0.03}") # ATUALIZAR PREÇO DEPOIS (tá veio)
...
print(f"O custo do GPT-4 é de {0.03/0.001} maior que o do GPT 3.5-turbo-1106")